...
case class Temporal[U: HW] private(override val P3: Seq[Matrix[F2]], override val P4: Seq[Matrix[F2]], dualPorted:Boolean=false) extends SLP(P3.head.m, P3.head.n, P3.size) {
