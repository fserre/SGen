...
/**
 * Class that represent a node in a streaming block internal graph. These nodes are comparable to DSL.RTL nodes, but abstract the hardware representation, and timing.
